...
export default class Particles {
    ...
    updateBuffers(edges, width, height) {
        try {
            ...
            const convertBezierPoints = (edgePoint, defaultPoint) => edgePoint ? { x: edgePoint.x, y: edgePoint.y } : { x: defaultPoint.x, y: defaultPoint.y };
