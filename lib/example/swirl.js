    ...
    Swirl.prototype.render = function () {
        ...
        return React.createElement("div", { key: "particle", style: { display: "inline-block", backgroundColor: "blue", height: height, width: width, overflow: "hidden" } },
            React.createElement(react_motion_1.Motion, { key: "roote", defaultStyle: {
                    ...
                    pos1x: react_motion_1.spring(0.1),
                    ...
                    pos4x: react_motion_1.spring(0.9),
                ...
                return React.createElement(__1.ParticleCanvas, { key: "demo-particles", style: {
                    ...
                    React.createElement(__1.ParticleEdge, { key: "node1", p0: { x: style.pos1x, y: style.pos1y }, p1: { x: style.pos2x, y: style.pos2y }, p2: { x: style.pos3x, y: style.pos3y }, p3: { x: style.pos4x, y: style.pos4y }, particleStyle: {
                        ...
                        }, ratePerSecond: _this.props.rate }));
            }));
    };
    return Swirl;
}(React.PureComponent));
