    ...
    Swirl.prototype.render = function () {
        ...
        return React.createElement("div", { key: "root", style: { display: "flex", flexDirection: "column", alignItems: "stretch", backgroundColor: "blue", height: height, width: width, overflow: "hidden" } },
            React.createElement(react_motion_1.Motion, { key: "roote", defaultStyle: {
                    ...
                    pos1: react_motion_1.spring(0.9 - (animationIndex % 5) / 20, { stiffness: 100, damping: 5 }),
                    pos2: react_motion_1.spring(0.15 + (animationIndex % 8) / 30, { damping: 5, stiffness: 100 }),
                    vpos: react_motion_1.spring((animationIndex % 10) / 20, { damping: 5, stiffness: 100 })
                } }, function (style) {
                return React.createElement(__1.ParticleCanvas, { key: "demo-particles", style: {
                    ...
                    React.createElement(__1.ParticleEdge, { key: "node1", p0: { x: style.pos2, y: 0.50 }, p1: { x: 0.5, y: 0.5 - style.vpos }, p2: { x: 0.200, y: 0.5 - style.vpos }, p3: { x: style.pos1, y: 0.5 }, particleStyle: {
                    ...
                    React.createElement(__1.ParticleEdge, { key: "node2", p0: { x: style.pos2, y: 0.50 }, p1: { x: 0.5, y: 0.5 + style.vpos }, p2: { x: 0.2, y: 0.5 + style.vpos }, p3: { x: style.pos1, y: 0.5 }, particleStyle: {
